...
schemas.PlayerStock = new mongoose.Schema({
...
schemas.Shareholder = new mongoose.Schema({
...
schemas.StockTransaction = new mongoose.Schema({
...
schemas.FamilyShareholder = new mongoose.Schema({
...
schemas.FamilyStockTransaction = new mongoose.Schema({
  userId: { type: String, required: true, index: true },
  familyId: { type: String, required: true, index: true },
  type: { type: String, enum: ["buy", "sell"], required: true },
  shares: { type: Number, required: true },
